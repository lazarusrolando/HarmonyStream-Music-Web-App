...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Save full user profile with default stats in localStorage
      const profileData = {
        email: formData.email,
      ...
      localStorage.setItem('harmonystream_user', JSON.stringify(profileData));
        ...
        <div className="w-full max-w-md glassmorphism p-8 rounded-2xl shadow-2xl border border-white/10">
          ...
          <div className="mt-6">
            <Button
              ...
              variant="default"
              fullWidth
              className="h-12 rounded-full text-base font-medium transition-all duration-200 hover:scale-[1.02] bg-green-600 text-white glassmorphism"
            >
              Log in with Spotify
            </Button>
          </div>
